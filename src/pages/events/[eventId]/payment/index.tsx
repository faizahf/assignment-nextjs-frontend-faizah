...
function PaymentPage() {
  ...
  return (
    <div className="flex flex-col w-full gap-10">
      ...
      <div className="border-secondary border-2 rounded-xl w-full p-5 shadow-md">

        <h2 className="font-semibold text-2xl">Order Summary</h2>
        <table className="w-full">
          <tr className="font-semibold border-t-2">Event</tr>
          <tr>
            <td>{event?.name}</td>
        ...
        {merchandises.length !== 0 && 
          <>
            <tr className="font-semibold border-t-2">Merchandise</tr>
      ...
      <div className="border-secondary border-2 rounded-xl p-5 shadow-md">
